...
public class T03ThreadTest {
	...
	public static void main(String[] args) {
		...
		try {
			th.join(); // 현재 실행중인 스레드에서 작업중인 스레드 (지금은 th 스레드)가 종료될 때까지 기다린다.
		...
		System.out.println("경과 시간(ms) : " + (endTime - startTime) + "milliSecond");
		System.out.println("경과 시간(s) : " + "0." + (endTime - startTime) + "Second");
	}
}
